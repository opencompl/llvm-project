...
void PresburgerRelation::unionInPlace(const IntegerRelation &disjunct) {
  assert(space.isCompatibleWithoutValues(disjunct.getSpace()) && "Spaces should match");
...
void PresburgerRelation::unionInPlace(const PresburgerRelation &set) {
  assert(space.isCompatibleWithoutValues(set.getSpace()) && "Spaces should match");
...
static PresburgerRelation getSetDifference(IntegerRelation b,
  ...
  assert(b.getSpace().isCompatibleWithoutValues(s.getSpace()) && "Spaces should match");
